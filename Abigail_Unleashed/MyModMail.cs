...
namespace MilkVillagers
{
    public class MyModMail : IAssetEditor
    {
        ...
        public void Edit<T>(IAssetData asset)
        {
            ...
            data["AbiEggplantT"] = $"Hey there, @. You really came through for me, there. That eggplant felt sooo good rubbing up against my pussy, and when I forced it into my ass I came so hard. I really hope you caught my show. Anyway, next time I need something smooth or bumpy, I know who to call on.   ^   Your friendly camgirl.";
            ...
            data["AbiCarrotsT"] = $"I don't know where you found that cave carrot, but the next time you find one make sure you bring it to me! My viewers loved seeing it tickle me inside and out, and I have to admit I lvoed it too. Not my first choice, but here's hoping the next request is a little more normal.   ^   Your veggie slut.";
            ...
            data["AbiRadishesT"] = $"I would NEVER have imagined that radishes could feel so good, but when I remembered that they came from your farm, I really got into them. Well, they certainly got into me. I had a whole bunch up there, and feeling them inside me was amazing.  ^  Your favourite camwhore.";
            ...
            data["AbiSurpriseT"] = $"I got more views last night than ever before! You would not BELIEVE how many people watched you pounding my ass all night, and I got SO MANY tips. You are the best friend ever, @.   ^   -Your slutty camgirl";
            ...
            data["MaruSampleT"] = $"Hello fellow researcher!^^That sample you got for me was pretty good, but I think it was contaminated. I think I'm going to need to get my samples straight from the source in future, but thank you for your help.   ^   ";
